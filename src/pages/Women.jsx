    ...
    >
      ...
      <div className="p-3 sm:p-4">
        ...
        <div className="flex items-center justify-between">
          <div>
            <span className="font-bold gradient-text-primary text-base">
  ...
  return (
    <div className="bg-[var(--bg)] text-[var(--text)] min-h-screen pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-6">
                  ...
                  >
                    {sorts.map((s) => (
                      <button
                        ...
                        className={`w-full text-left px-4 py-2.5 text-sm transition-colors hover:bg-[var(--card-bg)] ${sort === s ? "gradient-text-secondary font-semibold" : "text-[var(--muted)]"}`}
                      >
                        {s}
                      </button>
                    ))}
        ...
        >
          <div>
            <p className="gradient-text-secondary text-xs uppercase tracking-widest font-semibold mb-1">
              Exclusive
            </p>
            <h2 className="text-xl font-bold text-[var(--text)]">
              New Arrivals — Women's Edition 2025
            </h2>
          </div>
          <Link
            to="/women/shop"
            className="gradient-secondary text-[#080808] text-xs font-bold px-4 py-2 rounded-full hover:opacity-90 transition-opacity"
          >
            Explore →
          </Link>
        </motion.div>
