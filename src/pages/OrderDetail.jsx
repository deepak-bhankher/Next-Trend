  ...
  return (
    <div className="bg-[var(--bg)] text-[var(--text)] min-h-screen pt-32 pb-20">
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          <FiCheckCircle size={48} className="mx-auto mb-4 text-[var(--text)]" />
          <h1 className="text-3xl font-bold mb-2">Order Confirmed!</h1>
          <p className="text-[var(--muted)]">
            Order ID: <span className="text-[var(--text)]">{order._id}</span>
          </p>
        </motion.div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[var(--card-bg)] border border-[var(--border)] rounded-2xl p-6">
              ...
              <div className="flex items-center gap-2 text-sm">
                <span
                  className={`w-2 h-2 rounded-full ${
                    order.isPaid ? "bg-[var(--text)]" : "bg-[var(--muted)]"
                  }`}
                />
              ...
              <div className="flex items-center gap-2 text-sm mt-2">
                <span
                  className={`w-2 h-2 rounded-full ${
                    order.isDelivered ? "bg-[var(--text)]" : "bg-[var(--muted)]"
                  }`}
                />
                <span className="text-[var(--muted)]">
        ...
        <div className="text-center mt-10">
          <Link
            to="/men"
            className="inline-block gradient-primary text-[#080808] px-8 py-3 rounded-full font-semibold hover:scale-105 transition-transform"
          >
            Continue Shopping
          </Link>
        </div>
